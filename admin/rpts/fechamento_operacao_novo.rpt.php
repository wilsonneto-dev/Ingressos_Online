...
$pdf->titulo = (utf8_decode('Zé do Ingresso - #003 - Fechamento de Operação'));
...
$pdf->WriteHTML( "Evento: $id_evento - $ev->titulo" );

$pdf->Ln( 10 );

$pdf->Title(utf8_decode("Fechamento de Operação: $ev->titulo"));
