...
$r_tabelas_vendas->campos = "id;titulo;pedidos;ingressos;bruto;liquido_pedido;liquido;dia;mes;ano";
...
select 
    ...
    cast( case 
        when count(distinct tb.codigo) = 0 then 0
        else ( sum(tb.liquido) / count(distinct tb.codigo) ) 
    end as decimal(10,2)) as liquido_pedido,
